...
/* REMOVE "PRIVATE" from title in testing protected pages */
...
/* REGISTER MENU + CUSTOM NAV WALKER */
...
register_nav_menus( array(
    	'primary-mobile' => __( 'Mobile Menu', 'THEMENAME' ),
	) );
...
function wpdocs_excerpt_more( $more ) {
    return sprintf( '...<div class="center"><a class="btn btn-blue" href="%1$s">%2$s</a></div>',
...
/**
 * CONFIRM EMAIL in Contact Form - also gives error by field *
*/
