            ...
            <div class="row">
			  ...
			  <div class="col-md-10 col-md-offset-1">
			  		<div class='embed-container'>
			  		  <iframe src='https://player.vimeo.com/video/316848296' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
			  		</div>
			  		<div class="center">
			  		 <!-- <p style="color: #D9D9D9; font-size: 20px;">BUILD A HEART SAVE A LIFE</p> -->
			  		</div>
		      </div>
			  <!-- <div class="col-md-5 col-md-offset-1">
		  		 <div>	  		     <p align="left" valign="center" style="font-size:24px;"><span style="color: #fff; font-size: 24px;"><u><strong>IMPORTANT Investor Update – 12/8/18</strong></u></span></p><table>
<tbody>
<tr>
<td align="left" valign="top">
<p><span style="color: #ffffff; font-size: 12pt;">Effective January 31st, 2019 we will no longer be accepting investments through our equity crowdfunding offering.<br><br>Until then you can still contact us directly at 224-602-9569 and we will personally assist you in the investment process, whether it is making an initial investment or increasing your current equity position in BIOLIFE4D.<br><br>Our stock purchase price has already risen 20% from $10 to $12 a share since our campaign began in February and your time to participate and become a shareholder will end shortly.</span>
	<span class=".secure"><img title="Secure Payments by Credit Card." src="/wp-content/uploads/2018/04/CREDIT-CARDS-secure-WHITE-450-left.png" height="47" alt="Bioprinter layering bio-ink of human heart cells"/></span> 
  &nbsp;</p>
</td>
</tr>
</tbody>
    	...
    	<div class="container">
			...
			<div class="row home-invest">
			  ...
			  <div class="col-md-7 col-lg-8">
					...
					<div class="copy">BIOLIFE4D is now open for investors to purchase stock and participate in the development of this remarkable new process.</div>
                   <a href="https://cfxtrading.com/now/biolife4d.html" target="new" onclick="handleOutboundLinkClicks()" class="btn btn-red">Invest Now</a>
					<a class="btn btn-blue" href="/invest/"> Learn More</a>				
			    <span class=".secure"><img title="Secure Payments by Credit Card." src="/wp-content/uploads/2018/04/CREDIT-CARDS-secure-450-black-left.png" height="47" alt="Bioprinter layering bio-ink of human heart cells"/></span> -->
