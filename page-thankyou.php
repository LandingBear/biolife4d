...
<html <?php language_attributes(); ?> class="no-js no-svg">
  ...
  <body class="fixed-nav">
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle last" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">SCIENCE &amp; TECHNOLOGY <span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="/science-and-technology/">What is Bioprinting?</a></li>
                        <li><a href="/process">The BIOLIFE4D Bioprinting Process</a></li>
                        <li><a href="/adult-stem-cells/">Adult and iPS Stem Cells</a></li>
                        <li><a href="/history-of-bioprinting/">History of Bioprinting</a></li>
                        <li><a href="/process-optimization/">Process Optimization</a></li>
                        <li role="separator" class="divider"></li>
						<li><a href="/see-bioprinting-in-action/"><b>See Bioprinting in Action</b></a></li>
                      </ul>
                    </li>
                  </ul>
                  <div class="logo">
                ...
                <div class="col-md-4"> 
                	<div class="info">
                        ...
                        <div class="social">
							...
							<a href="https://www.youtube.com/channel/UCUGfCNrPak61lBl0jIiRGJw" target="_blank"><img class="alignleft wp-image-170 size-full" src="https://biolife4d.com/wp-content/uploads/2017/07/icon-social-youtube.png" alt="" width="65" height="64" /></a>
						</div>
                        <!--
	...
	<script type="text/javascript">
		/* <![CDATA[ */
		var google_conversion_id = 833939828;
		var google_conversion_language = "en";
		var google_conversion_format = "3";
		var google_conversion_color = "ffffff";
		var google_conversion_label = "9dV2CITMrHUQ9NLTjQM";
	...
	<noscript>
		...
		<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/833939828/?label=9dV2CITMrHUQ9NLTjQM&amp;guid=ON&amp;script=0"/>
		</div>
	</noscript>
