<?php
/*
 * Template Name: Investors ONLY Page
 */
?>
...
<html <?php language_attributes(); ?> class="no-js no-svg">
   <head>
    ...
    <link href="/wp-content/themes/biolife4d/assets/css/style.css" rel="stylesheet">
  ...
  <body class="fixed-nav">
    ...
    <!-- Header -->
    <header>
        <nav class="navbar navbar-default navbar-fixed-top logo-stay">
           	<?php 
			  // Fix menu overlap
